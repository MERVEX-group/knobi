...
#' \item method: sets whether the fit is carried using 'SSB' or 'Biomass'. This argument is only required if both time series, 'Spawning_Biomass' and 'Biomass', are provided.}
...
#'
#' control<-list()
#' control$pella<-"TRUE" # Logical. T means that the Pella-Tomlinson model is used.
