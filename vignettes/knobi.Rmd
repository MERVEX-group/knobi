...
The first plot reports the correlation analysis between the environmental variable(s) and the base KBPM surplus production residuals. Next 3D plots reports the surplus production curve conditioned to a grid of environmental values. The last one reports the fitted values of the base model (no environmental information) and of the environmental ones.
