...
In the case of `multicovar = TRUE` in `knobi_env`, an example of the list that is required, which each item is a data frame for each environmental scenario.
